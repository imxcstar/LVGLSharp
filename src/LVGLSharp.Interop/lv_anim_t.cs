...
{
    public unsafe partial struct lv_anim_t
    {
        public void* var;
        ...
        public delegate* unmanaged[Cdecl]<lv_anim_t*, int, void> custom_exec_cb;

        [NativeTypeName("lv_anim_start_cb_t")]
        public delegate* unmanaged[Cdecl]<lv_anim_t*, void> start_cb;

        [NativeTypeName("lv_anim_completed_cb_t")]
        public delegate* unmanaged[Cdecl]<lv_anim_t*, void> completed_cb;

        [NativeTypeName("lv_anim_deleted_cb_t")]
        public delegate* unmanaged[Cdecl]<lv_anim_t*, void> deleted_cb;

        [NativeTypeName("lv_anim_get_value_cb_t")]
        public delegate* unmanaged[Cdecl]<lv_anim_t*, int> get_value_cb;

        public void* user_data;

        [NativeTypeName("lv_anim_path_cb_t")]
        public delegate* unmanaged[Cdecl]<lv_anim_t*, int> path_cb;
