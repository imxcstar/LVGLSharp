...
{
    public unsafe partial struct lv_font_t
    {
        [NativeTypeName("bool (*)(const lv_font_t *, lv_font_glyph_dsc_t *, uint32_t, uint32_t)")]
        public delegate* unmanaged[Cdecl]<lv_font_t*, lv_font_glyph_dsc_t*, uint, uint, c_bool1> get_glyph_dsc;

        [NativeTypeName("const void *(*)(lv_font_glyph_dsc_t *, lv_draw_buf_t *)")]
        public delegate* unmanaged[Cdecl]<lv_font_glyph_dsc_t*, lv_draw_buf_t*, void*> get_glyph_bitmap;

        [NativeTypeName("void (*)(const lv_font_t *, lv_font_glyph_dsc_t *)")]
        public delegate* unmanaged[Cdecl]<lv_font_t*, lv_font_glyph_dsc_t*, void> release_glyph;
