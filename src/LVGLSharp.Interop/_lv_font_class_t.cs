...
{
    public unsafe partial struct _lv_font_class_t
    {
        [NativeTypeName("lv_font_t *(*)(const lv_font_info_t *, const void *)")]
        public delegate* unmanaged[Cdecl]<_lv_font_info_t*, void*, _lv_font_t*> create_cb;

        [NativeTypeName("void (*)(lv_font_t *)")]
        public delegate* unmanaged[Cdecl]<_lv_font_t*, void> delete_cb;
