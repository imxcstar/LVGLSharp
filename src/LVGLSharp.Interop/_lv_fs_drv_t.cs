namespace LVGLSharp.Interop
{
    public unsafe partial struct _lv_fs_drv_t
    {
        ...
        public delegate* unmanaged[Cdecl]<_lv_fs_drv_t*, sbyte*, lv_fs_mode_t, void*> open_cb;
        ...
        public delegate* unmanaged[Cdecl]<_lv_fs_drv_t*, void*, void*, uint, uint*, lv_fs_res_t> read_cb;

        [NativeTypeName("lv_fs_res_t (*)(lv_fs_drv_t *, void *, const void *, uint32_t, uint32_t *)")]
        public delegate* unmanaged[Cdecl]<_lv_fs_drv_t*, void*, void*, uint, uint*, lv_fs_res_t> write_cb;

        [NativeTypeName("lv_fs_res_t (*)(lv_fs_drv_t *, void *, uint32_t, lv_fs_whence_t)")]
        public delegate* unmanaged[Cdecl]<_lv_fs_drv_t*, void*, uint, lv_fs_whence_t, lv_fs_res_t> seek_cb;

        [NativeTypeName("lv_fs_res_t (*)(lv_fs_drv_t *, void *, uint32_t *)")]
        public delegate* unmanaged[Cdecl]<_lv_fs_drv_t*, void*, uint*, lv_fs_res_t> tell_cb;

        [NativeTypeName("void *(*)(lv_fs_drv_t *, const char *)")]
        public delegate* unmanaged[Cdecl]<_lv_fs_drv_t*, sbyte*, void*> dir_open_cb;

        [NativeTypeName("lv_fs_res_t (*)(lv_fs_drv_t *, void *, char *, uint32_t)")]
        public delegate* unmanaged[Cdecl]<_lv_fs_drv_t*, void*, sbyte*, uint, lv_fs_res_t> dir_read_cb;
